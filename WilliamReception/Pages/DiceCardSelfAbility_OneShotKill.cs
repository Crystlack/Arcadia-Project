...
{
    public class DiceCardSelfAbility_OneShotKill : DiceCardSelfAbilityBase
    {
        public static string Desc = "Costs 1 less at Emotion Level 3 or higher; [On Use] Draw 1 page";
