...
{
    public class BehaviourAction_reapAction2 : BehaviourActionBase
    {
          ...
          ref RencounterManager.ActionAfterBehaviour opponent)
        {
            ...
            {
                RencounterManager.MovingAction movingAction2 = new RencounterManager.MovingAction(ActionDetail.Slash, CharMoveState.MoveForward, 30f, false, 0.5f);
