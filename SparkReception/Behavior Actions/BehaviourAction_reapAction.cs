...
{
    public class BehaviourAction_reapAction : BehaviourActionBase
    {
          ...
          ref RencounterManager.ActionAfterBehaviour opponent)
        {
            ...
            {
                RencounterManager.MovingAction movingAction2 = new RencounterManager.MovingAction(ActionDetail.S2, CharMoveState.MoveForward, 30f, false, 0.5f);
